...
class Ball:
    ...
    def draw(self):
        ...
        if pos[3] >= self.canvas_height:
            ...
            canvas.create_text(250, 120, text='АХАХАХАХАХАХХАХХАХАХАХАХАХАХАХАХАХАХАХАХАХАХАХАХАХААХАХААХАХХААХАХАХАХАХАХАХХАХАХАХАХАХАХАХААХАХАХАХАХХАХАХАХАХАХАХАХАХАХАХАХА))))))))))))))))))))))))', font=('Courier', 30), fill='red')
...
class Score:
    ...
    def __init__(self, canvas, color):
        ...
        self.id = canvas.create_text(4500, 100, text=self.score, font=('Courier', 15), fill=color)
